package cc.novoline.yuxiangll.BackGround;
...
public class BackGround {
    ...
    public BackGround(String fragmentShaderLocation)throws IOException {
        int program = GL20.glCreateProgram();
        GL20.glAttachShader(program, this.createShader(BackGround.class.getResourceAsStream("/assets/minecraft/background/passthrough.vsh"), 35633));
        GL20.glAttachShader(program, this.createShader(BackGround.class.getResourceAsStream(fragmentShaderLocation), 35632));
