...
import cc.novoline.yuxiangll.fontRenderer.ttfr.StringCache;
...
//    public int drawStringWithNewShadow(String text, float x, int y, int color) {
//        RenderUtil.drawImage(new ResourceLocation("client/fontshadow.png"), x - 10, y - 37 / 2f + 3, getStringWidth(text) + 18, 37);
//        return this.drawString(text, x, (float) y, color, false);
//    }
//
