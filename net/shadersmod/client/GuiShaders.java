...
public class GuiShaders extends GuiScreen {
                ...
                switch (button.id) {
                    case 201:
                        switch (getOSType()) {
                            case 1:
                                final String s = String
                                        .format("cmd.exe /C start \"Open file\" \"%s\"", Shaders.shaderpacksdir.getAbsolutePath());
                        ...
                        try {
                            ...
                            oclass1.getMethod("browse", new Class[]{URI.class})
                                    .invoke(object1, new File(this.mc.mcDataDir, "shaderpacks").toURI());
                    ...
                    case 210:
                        try {
                            ...
                            oclass.getMethod("browse", new Class[]{URI.class})
                                    .invoke(object, new URI("http://optifine.net/shaderPacks"));
    ...
    public static int getOSType() {
        ...
        return s.contains("win") ? 1 : s.contains("mac") ? 2 :
                s.contains("solaris") ? 3 : s.contains("sunos") ? 3 : s.contains("linux") ? 4 : s.contains("unix") ? 4 : 0;
    }
