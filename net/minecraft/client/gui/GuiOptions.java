    ...
    public void initGui() {
        ...
        this.buttonList.add(new GuiButton(8675309, this.width / 2 + 5, this.height / 6 + 48 - 6, 150, 20, "Super Secret Settings...") {
            public void playPressSound(@NonNull SoundHandler soundHandler) {
                SoundEventAccessorComposite soundeventaccessorcomposite = soundHandler.getRandomSoundFromCategories(new SoundCategory[]{SoundCategory.ANIMALS, SoundCategory.BLOCKS, SoundCategory.MOBS, SoundCategory.PLAYERS, SoundCategory.WEATHER});
