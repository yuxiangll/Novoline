...
public class GuiTextField extends Gui {
    ...
    public void func_175205_a(java.util.function.Predicate<String> p_175205_1_) {
    ...
    public void drawTextBox() {
        if (getVisible()) {
            ...
            if (flag1) {
                if (flag2) {
                    drawRect(k1, i1 - 1, k1 + 1, i1 + 1 + this.fontRendererInstance.getHeight(), -3092272);
                } else {
            ...
            if (k != j) {
                ...
                drawCursorVertical(k1, i1 - 1, l1 - 1, i1 + 1 + this.fontRendererInstance.getHeight());
            }
        }
    }
