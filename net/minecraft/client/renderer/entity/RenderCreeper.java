...
public class RenderCreeper extends RenderLiving<EntityCreeper> {
     ...
     */
    protected void preRenderCallback(EntityCreeper entityLivingBase, float partialTickTime) {
     ...
     */
    protected int getColorMultiplier(EntityCreeper entityLivingBase, float lightBrightness, float partialTickTime) {
        float f = entityLivingBase.getCreeperFlashIntensity(partialTickTime);
